    ...
    <>
      <section className="bg-black w-full h-auto py-44 md:pt-52 lg:pt-48 pt-40 md:px-14 px-5 text-white  ">
            ...
            <div className="md:w-9/12 overflow-hidden">
              <div className="flex items-start mb-8">
                ...
                <div className="text-md">
                  ...
                  <p className="text-white/50 text-[12px] lg:text-[14px] font-roboto xl:w-[600px]">
              ...
              <div className="flex items-start mb-8">
                ...
                <div className="text-md">
                  ...
                  <p className="text-white/50  text-[12px] lg:text-[14px] font-roboto">
        ...
        <div className="flex justify-center items-center gap-[10px] relative top-[-40px]">
          ...
          <Link
            href="/contact"
            className="text-blue-600 underline text-[13px] font-normal font-roboto"
          >
            Contact Us
          </Link>
        </div>
