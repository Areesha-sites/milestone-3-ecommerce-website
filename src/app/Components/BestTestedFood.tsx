      ...
      <section className="w-full md:py-28 py-11 md:px-14 px-5 bg-black flex justify-between">
        ...
        data-aos-delay="200"
          ...
          <div className="md:w-[570px] w-full h-[350px] flex justify-between flex-col">
            <h1
             data-aos="fade-up"
        data-aos-delay="200"
            className="md:text-4xl text-2xl font-extrabold text-center md:text-left text-white font-roboto uppercase">
              Experience the Finest Food & Drinks at Your Fingertips
            </h1>
            <div 
             data-aos="fade-up"
        data-aos-delay="200"
            className="border-b-[4px] border-btnBackground w-[120px] md:mx-0 mx-auto"></div>
            <p
             data-aos="fade-up"
        data-aos-delay="200"
            className="text-white/60 md:text-[14px] text-[12px] md:text-left text-center font-roboto">
        ...
        data-aos-delay="200"
                className="w-[100px] h-[20px] flex items-center gap-[8px]">
                  ...
                  className="font-roboto text-white/60 md:text-[14px] text-[12px] whitespace-nowrap">
                    Affordable Prices
                  </span>
                </div>
                <div
        ...
        data-aos-delay="200"
          ...
          <div
            data-aos="fade-up"
        data-aos-delay="200"
          className="flex md:justify-start items-center justify-center">
