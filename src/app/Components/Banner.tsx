        ...
        >
          <SwiperSlide>
            <div className="w-full md:h-[100vh] overflow-hidden bg-black md:min-h-screen text-white cursor-pointer relative pt-28 md:pt-0 pb-96 md:pb-0">
              <h1 className="absolute inset-0 flex justify-center items-center md:flex-row flex-col xl:text-[17rem] lg:text-[13rem] md:text-[10rem] text-[4.5rem] font-extrabold opacity-10 md:mt-14 -mt-56 z-0 font-roboto md:text-left">
                Feliciano
              </h1>
              <div className="flex justify-between items-center md:flex-row flex-col gap-y-[20px] lg:mt-28 md:mt-36 lg:px-20 md:px-9 relative z-10 px-5 text-center md:text-left">
                <div>
                  ...
                  <h1
                    data-aos="fade-up"
                    data-aos-delay="200"
                    className="font-nunito xl:text-8xl lg:text-[85px] lg:leading-[88px] md:text-[70px] md:leading-[67px] font-extrabold z-20 relative text-[40px] leading-[45px]  md:text-left"
                  >
                    Crispy <br /> Chic
                  ...
                  <h3
                    data-aos="fade-up"
                    data-aos-delay="200"
                    className="md:text-[14px] ml-2 xl:w-[50%] lg:w-[70%] md:w-[60%] relative z-20 w-full text-[12px] font-roboto "
                  >
              ...
              <div className="flex justify-between items-center md:flex-row flex-col gap-y-[20px]  lg:mt-28 lg:px-20 md:mt-32 md:px-9 relative z-10 text-center px-5 md:text-left">
                <div>
                  ...
                  <h1
                    data-aos="fade-up"
                    data-aos-delay="200"
                    className="font-nunito xl:text-8xl lg:text-[85px] lg:leading-[88px]  font-extrabold z-20 relative md:text-[70px] md:leading-[67px] text-[40px] leading-[45px] "
                  >
                  ...
                  <h3
                    data-aos="fade-up"
                    data-aos-delay="200"
                    className="md:text-[14px] ml-2 xl:w-[50%] lg:w-[70%] md:w-[60%] md:mt-4 w-full text-[12px] font-roboto mt-2"
                  >
              ...
              <div className="flex justify-between md:flex-row flex-col items-center lg:mt-28 gap-y-[20px] md:mt-32 md:px-9 lg:px-20 relative z-10 px-5 text-center md:text-left">
                <div>
                  ...
                  <h3
                    data-aos="fade-up"
                    data-aos-delay="200"
                    className="md:text-[14px] ml-2 xl:w-[50%] lg:w-[70%] relative z-20 md:w-[60%] w-full text-[12px] font-roboto md:mt-2"
                  >
