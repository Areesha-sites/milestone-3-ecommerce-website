...
const MenuTabs = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-[300px] mx-auto md:w-[700px] md:max-w-[1280px]">
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-y-[30px] gap-[10px] lg:gap-[20px] md:w-[700px] xl:w-[1100px] lg:w-[900px] relative top-[30px] mx-auto w-full lg:left-[-100px] xl:left-[-180px] xs:ml-[-10px] ms:ml-0 xsm:ml-0 sm:ml-0">
