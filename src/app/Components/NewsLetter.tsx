      ...
      <div className="w-full lg:h-[230px] h-[170px] bg-btnBackground xl:px-20 px-6 lg:py-16 py-6">
        <div className="flex justify-between items-center lg:flex-row flex-col">
          <div className="flex flex-col gap-[10px]">
            <h1 className="xl:text-[38px] lg:text-[35px] md:text-[31px] text-[25px] leading-[20px] whitespace-nowrap text-black font-extrabold uppercase font-roboto">
              Get Exclusive Update
            </h1>
            <p className="lg:text-[15px] md:text-[14px] text-[12px] text-white text-center  font-normal font-roboto">
