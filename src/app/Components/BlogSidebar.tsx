...
<div className="relative w-full flex justify-end items-center ">
  <button
    className="block lg:hidden relative top-[-2910px] ms:top-[-2940px] sm:top-[-2940px] sm:left-[290px] xsm:left-[340px] xsm:top-[-2960px] left-[240px] ms:left-[300px] hover:bg-btnBackground card-bg p-2 rounded-full md:top-[-50px] md:left-[250px]"
  ...
  >
    ...
    <aside
        ...
        } lg:translate-x-0 fixed lg:static top-0 left-0 z-40 h-[100vh]  bg-black lg:bg-transparent text-white w-full lg:w-auto p-5 md:p-0 transform transition-transform duration-300 overflow-y-auto md:w-[400px]`}
      >
     ...
     <button
        ...
        <div className="lg:w-[330px] md:mx-auto md:w-[360px] sm:w-[340px] xsm:w-[380px] h-[340px] text-white border-[1px] border-gray-900 py-4 px-7 flex flex-col gap-[25px]">
          <div className="flex gap-[10px] justify-start items-center">
            <span className="border-l-[2px] border-btnBackground h-[20px]"></span>
            <span className="text-white font-medium font-roboto text-[18px] uppercase">
              Popular Feeds
        ...
        <div className="lg:w-[330px] md:mx-auto md:w-[360px] sm:w-[340px] xsm:w-[380px] h-[570px] text-white border-[1px] border-gray-900 py-4 px-7 flex flex-col gap-[25px]">
          <div className="flex gap-[10px] justify-start items-center">
            <span className="border-l-[2px] border-btnBackground h-[20px]"></span>
            <span className="text-white font-medium font-roboto text-[18px] uppercase">
              Categories
        ...
        <div className="lg:w-[330px] md:mx-auto md:w-[360px] sm:w-[340px] xsm:w-[380px]  h-[130px] text-white border-[1px] border-gray-900 py-4 px-7 flex flex-col gap-[25px]">
          <div className="flex gap-[10px] justify-start items-center">
            <span className="border-l-[2px] border-btnBackground h-[20px]"></span>
            <span className="text-white font-medium font-roboto text-[18px] uppercase">
              Never Miss News
        ...
        <div className="lg:w-[330px] md:mx-auto md:w-[360px] sm:w-[340px] xsm:w-[380px] h-[270px] text-white border-[1px] border-gray-900 py-4 px-7 flex flex-col gap-[10px]">
          <div className="flex gap-[10px] justify-start items-center ">
            <span className="border-l-[2px] border-btnBackground h-[20px]"></span>
            <span className="text-white font-medium font-roboto text-[18px] uppercase">
              Popular Tags
