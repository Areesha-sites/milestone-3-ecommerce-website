      ...
      <section className="bg-black w-full xl:h-auto py-60 md:pt-52 lg:pt-48 lg:py-40 xl:px-20 pt-40 md:px-14 px-5 text-white md:py-96 lg:px-10">
        <div className="flex justify-center items-center flex-col gap-y-5">
          ...
          <h1
            data-aos="fade-up"
            data-aos-delay="200"
            className="uppercase xl:text-[48px] md:text-[38px] text-[28px] leading-[30px] font-bold font-poppins lg:text-[43px] text-center md:leading-[35px] lg:leading-[40px] lg:px-11 xl:w-[800px] xl:leading-[48px]"
          >
            Fast & Flavorful:{" "}
        ...
        <div className="xl:w-[700px] lg:w-[600px] h-auto text-white flex flex-col gap-[30px] md:gap-[25px] relative top-[80px]">
          <h1
            data-aos="fade-up"
            data-aos-delay="200"
            className="lg:text-[32px] text-[25px] text-white font-roboto font-bold leading-[26px] lg:leading-[35px] uppercase md:text-[30px] md:leading-[35px]"
          >
            {" "}
          ...
          <p
            data-aos="fade-up"
            data-aos-delay="200"
            className="font-roboto text-[12px] lg:text-[14px] text-white/50 font-normal"
          >
            {product.des}
          </p>
          <p
          ...
          <h2
            data-aos="fade-up"
            data-aos-delay="200"
            className="lg:text-[20px] text-[18px] text-white font-semibold font-roboto uppercase"
          >
          ...
          <p
            data-aos="fade-up"
            data-aos-delay="200"
            className="font-roboto text-[12px] lg:text-[14px] text-white/50 font-normal relative lg:left-[290px] lg:w-[300px] xl:w-[400px] w-full lg:top-[-275px] left-[5px]"
          >
            {product.para5}
          </p>
          <p
            data-aos="fade-up"
            data-aos-delay="200"
            className="font-roboto text-[12px] lg:text-[14px] text-white/50 font-normal relative lg:left-[290px] lg:w-[300px] xl:w-[400px] lg:top-[-270px] w-full left-[5px]"
          >
            {product.para6}
          </p>
          ...
          <div
            data-aos="fade-up"
            data-aos-delay="200"
            className="md:flex justify-between items-center md:flex-row flex-col absolute xl:top-[1930px] lg:top-[2050px] lg:w-[600px] xl:w-[680px] md:w-[680px] w-[280px] top-[2360px] left-[-10px] gap-y-[20px] ms:top-[1300px] hidden md:top-[1680px] mx-auto md:px-5 "
          >
            <div className="flex flex-col gap-[10px]">
          ...
          <div className="relative lg:top-[-100px] top-[50px] left-[10px] lg:left-0 md:top-[100px]">
            <h1
              data-aos="fade-up"
              data-aos-delay="200"
              className="text-white font-bold text-[20px] lg:text-[25px] font-roboto uppercase"
            >
              03 Comments
            </h1>
            <div
          ...
          <div className="relative lg:top-[-60px] top-[80px] md:top-[130px]">
            <h1
              data-aos="fade-up"
              data-aos-delay="200"
              className="text-white font-bold lg:text-[25px] text-[20px] font-roboto uppercase"
            >
              Post Comment
            </h1>
            <div
        ...
        <div className="">
          <div
            data-aos="fade-up"
            data-aos-delay="200"
            className="absolute xl:left-[850px] lg:left-[650px] lg:top-[500px] md:top-[3400px] md:left-[60px] top-[4400px] sm:top-[4070px] xsm:top-[4000px] xl:top-[565px]"
          >
            <BlogSidebar />
          </div>
        </div>
