...
const About = () => {
  return (
    <>
      <section className="w-full bg-black text-white h-auto px-2 py-36 lg:pt-48">
        <div className="grid xl:grid-cols-2 grid-cols-1 md:grid-cols-2 gap-7 mx-auto px-4 sm:px-6 xl:px-24 max-w-[1200px]">
          <div className="relative flex flex-col items-center">
            ...
            />
            <div className="about-tag bg-btnBackground w-[130px] h-[50px] xl:w-[180px] xl:h-[80px] lg:w-[150px] lg:h-[60px] text-[12px] xl:text-[23px] font-roboto text-white font-bold uppercase rounded-[10px] flex justify-center items-center mt-4 relative xl:top-[-130px] xl:left-[100px] left-[60px] top-[-80px] md:text-[18px]">
              since /1985
            </div>
          </div>

          <div className="">
            <span className="xl:text-[18px] text-[14px] mt-2 font-greatVibes text-btnBackground font-normal">
              About Our Food
            </span>
            <h1 className="text-white xl:text-[43px] text-[28px] leading-[30px] xl:leading-[50px] mt-3 font-extrabold uppercase  font-roboto lg:text-[35px] lg:leading-[35px] ">
              The <span className="text-btnBackground">Heart</span> of Chow
              Champs
            </h1>
            <p className=" text-[12px] xl:text-[14px] text-white/65 font-normal mt-5 font-roboto">
            ...
            <div className="flex gap-[5px] flex-col">
              <div className="flex xl:items-center items-start md:flex-row flex-col justify-start gap-[20px] mt-4">
                <div>
                  <Image
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 md:grid-cols-2 gap-y-[20px] gap-x-4 relative top-[80px] px-4">
          <div className="col-span-1 w-full h-[170px] card-bg rounded-[10px] flex flex-col justify-center items-center">
          ...
          <div className="col-span-1 sm:col-span-1 w-full h-[170px] card-bg rounded-[10px] flex flex-col justify-center gap-[5px] items-center">
          ...
          <div className="col-span-1 sm:col-span-1 md:col-span-2 lg:col-span-1 w-full h-[170px] card-bg rounded-[10px] flex flex-col justify-center items-center">
            <Image
        ...
        <div className="relative w-full xl:h-[56vh] xl:py-40 md:h-[30vh] lg:py-36 h-auto py-7 mt-16 top-[100px]">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full text-white">
            <div className="flex justify-between items-center md:flex-row flex-col gap-[20px] md:px-6">
              <div className="">
                <p className="text-[16px] text-btnBackground font-normal font-greatVibes z-30">
                  crispy, every bite taste
                </p>
                <h1 className="xl:text-[40px] text-[25px] leading-[30px] font-extrabold font-roboto uppercase xl:leading-[40px] md:w-[323px] md:text-[31px] lg:text-[40px] xl:w-[450px] lg:w-[450px] lg:leading-[40px] z-50">
                  30 minutes fast <br />
              ...
              <div className="">
                <Image
                  ...
                  height={100}
                  width={100}
                  className="xl:h-[300px] xl:w-[400px] h-[180px] w-[230px] md:w-[270px] md:h-[150px] lg:h-[250px] lg:w-[360px]"
                />
              </div>
              <div className="">
                <Image
              ...
              <button className="xl:h-[50px] xl:w-[160px] xl:py-3 h-[40px] w-[130px] py-2 px-5 rounded-[5px] bg-btnBackground outline-none text-white font-roboto text-[14px] whitespace-nowrap xl:text-[16px] font-semibold flex justify-center gap-[7px] items-center hover:bg-hoverBtnBackground">
