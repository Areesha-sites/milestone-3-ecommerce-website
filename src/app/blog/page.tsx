...
const Blog = () => {
  return (
    <>
      <section className="bg-black w-full h-auto md:py-44 md:pt-52 lg:pt-48 pt-40 md:px-14 px-5 text-white">
        <div className="flex justify-center items-center flex-col gap-y-5">
          ...
          <h1 className="uppercase xl:text-[48px] lg:w-[500px] xl:w-[700px] md:text-[38px] text-[28px] leading-[30px] font-bold font-poppins lg:text-[43px] text-center md:leading-[45px]">
        ...
        <div className="absolute xl:top-[450px] top-[3280px] xl:left-[860px] md:left-[415px] left-[14px] md:top-[463px] lg:left-[680px] lg:top-[445px]">
          <BlogSidebar />
        </div>
      </section>
    </>
