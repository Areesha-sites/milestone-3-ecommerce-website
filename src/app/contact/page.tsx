    ...
    <>
      <section className="bg-black w-full h-auto py-44 md:pt-44 lg:pt-48 pt-40 md:px-14 px-5 text-white lg:w-[1440px] mx-auto relative">
        <div className="flex justify-center items-center flex-col gap-y-5">
          <span className="xl:text-[18px] md:text-[15px] text-[14px] mb-[-20px] lg:mb-[-10px] md:mb-[-20px] font-greatVibes text-btnBackground font-normal">
            We're Just a Message Away!
          </span>
          <h1 className="uppercase xl:text-[48px] md:text-[38px] text-[28px] text-center leading-[30px] font-bold font-poppins lg:text-[43px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:gap-[100px] md:gap-[50px] lg:gap-[140px] xl:pt-40 md:pt-20 pt-12 md:px-0">
          <div className="">
            <div className="flex justify-center flex-col gap-y-5">
              <h1 className="uppercase md:text-[20px] lg:text-[24px] xl:text-[35px] text-[19px] font-bold font-poppins">
                Get Closer
              </h1>
              <div className="border-b-[4px] w-[100px] border-btnBackground"></div>
            ...
            <div className="grid grid-cols-2 md:gap-[15px] pt-11">
              <div className="flex justify-start xl:gap-[20px] items-center  md:relative md:left-[-20px]">
                <Image
              ...
              <div className="flex justify-start md:gap-[15px] items-center md:relative md:left-[-20px]">
                <Image
          ...
          <div className="xl:w-[500px] w-[280px] md:h-auto sm:w-[340px] xsm:w-[350px] h-auto relative top-[50px] mx-auto md:top-0 xl:left-[-130px] md:left-[-25px] lg:left-[-120px]">
            <h3 className="font-bold text-white uppercase font-poppins tracking-tight text-left text-[19px] md:text-[20px] lg:text-[24px] xl:text-[35px]">
              Your Details
            </h3>
        ...
        <div className="border-b-[3px] border-white/20 w-[280px] xsm:w-[380px] sm:w-[330px] relative mx-auto top-[60px] my-5 md:w-[310px] md:top-[-130px] md:left-[-180px] lg:left-[-260px] lg:w-[400px] xl:w-[500px] xl:left-[-340px] xl:top-[-140px]"></div>

        <div className="flex justify-between items-center xl:w-[490px] md:w-[310px] lg:w-[400px] md:top-[-130px] relative top-[50px] xl:top-[-150px]">
        ...
        <div className="relative rounded-lg overflow-hidden shadow-md md:h-96 h-64 md:top-[70px] top-[80px] xl:top-[20px]">
          <iframe
