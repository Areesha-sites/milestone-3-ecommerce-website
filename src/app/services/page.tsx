...
const servicesData: ServicesCardsPropsTypes[] = [
  {
    id: "1",
    icon: <FaTruck className="h-12 w-12 text-btnBackground group-hover:text-white" />, 
  ...
  {
    id: "2",
    icon: <FaConciergeBell className="h-12 w-12 text-btnBackground group-hover:text-white" />,
  ...
  {
    id: "3",
    icon: <FaHamburger className="h-12 w-12 text-btnBackground group-hover:text-white" />, 
  ...
  {
    id: "4",
    icon: <FaUserTie className="h-12 w-12 text-btnBackground group-hover:text-white"/>,
    ...
    <>
      <section className="bg-black w-full h-auto py-44 md:pt-52 lg:pt-48 pt-40 md:px-14 px-5 text-white">
        <div className="flex justify-center items-center flex-col gap-y-5">
          ...
          <h1 className="uppercase xl:text-[48px] md:text-[38px] text-[28px] leading-[30px] font-bold font-poppins lg:text-[43px] text-center xl:leading-[45px] xl:w-[800px] md:leading-[38px]">
